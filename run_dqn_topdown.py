...
def train(env, agent, stack_frames, img_size, top_down_img_size, exp_path="experiments_rl", eps_steps=1000, max_steps=1000000):
    total_step = 0
    episode = 0
    ...
    while True:
        ...
        while True:
            ...
            if total_step % 10000 == 0:
                ...
                print("Generate GIF ...")
                img_buffer, score = play(env, agent, stack_frames, img_size, top_down_img_size)
...
if __name__ == "__main__":
    ...
    if not test:
        train(env, agent, stack_frames, img_size, top_down_img_size, model_path, eps_steps=1000, max_steps=800000)
    else:
